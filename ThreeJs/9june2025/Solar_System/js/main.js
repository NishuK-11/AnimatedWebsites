...
function createMaterialArray() {
 const skyboxImagepaths = [
  '../../Solar_System/img/skybox/space_ft.png',
  '../../Solar_System/img/skybox/space_bk.png',
  '../../Solar_System/img/skybox/space_up.png',
  '../../Solar_System/img/skybox/space_dn.png',
  '../../Solar_System/img/skybox/space_rt.png',
  '../../Solar_System/img/skybox/space_lf.png',
];
...
function init() {
  ...
  setSkyBox();
 planet_earth = loadPlanetTexture("../../Solar_System/img/earth_hd.jpg", 4, 100, 100, 'standard');
planet_sun = loadPlanetTexture("../../Solar_System/img/sun_hd.jpg", 20, 100, 100, 'basic');
planet_mercury = loadPlanetTexture("../../Solar_System/img/mercury_hd.jpg", 2, 100, 100, 'standard');
planet_venus = loadPlanetTexture("../../Solar_System/img/venus_hd.jpg", 3, 100, 100, 'standard');
planet_mars = loadPlanetTexture("../../Solar_System/img/mars_hd.jpg", 3.5, 100, 100, 'standard');
planet_jupiter = loadPlanetTexture("../../Solar_System/img/jupiter_hd.jpg", 10, 100, 100, 'standard');
planet_saturn = loadPlanetTexture("../../Solar_System/img/saturn_hd.jpg", 8, 100, 100, 'standard');
planet_uranus = loadPlanetTexture("../../Solar_System/img/uranus_hd.jpg", 6, 100, 100, 'standard');
planet_neptune = loadPlanetTexture("../../Solar_System/img/neptune_hd.jpg", 5, 100, 100, 'standard');
